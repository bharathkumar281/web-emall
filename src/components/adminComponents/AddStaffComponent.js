                    ...
                    <Col xs={12} sm={10} md={8} lg={6}>
                        ...
                        <Form onSubmit={(event) => { this.addStaff(event) }}>
                            <Form.Group controlId="formUsername" >
                                ...
                                <Form.Control name="username" required className="add-shadow-small" placeholder="username"
                                    type="text" minLength="3" maxLength="15" />
                            </Form.Group>
                            <Form.Group controlId="formPassword">
                                <Form.Label>Password:</Form.Label>
                                <Form.Control name="password" required className="add-shadow-small" placeholder="password"
                                    type="password" minLength="4" maxLength="10" />
                            </Form.Group>
                            <Form.Group controlId="formEmail" >
                                <Form.Label>Email:</Form.Label>
                                <Form.Control name="email" required className="add-shadow-small"
